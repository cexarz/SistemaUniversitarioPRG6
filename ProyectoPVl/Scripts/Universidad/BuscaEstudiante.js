...
function AgregarEstudiantesTabla(data){
    ...
    $(data).each(function () {
        ...
        var fila = '<tr><td>' + opcionActual.NombreCompleto + '</td><td>' + opcionActual.Cedula +
            ...
            '</td><td><a href="ConsultarOfertaXEstudiante?id_Estudiante=' + opcionActual.id_Estudiante + '">Consultar matricula</a><br />' +
            '<a href="ModificaEstudiante?id_Estudiante=' + opcionActual.id_Estudiante + '">Modificar    |</a>' +
            '<a href="EliminaEstudiante?id_Estudiante=' + opcionActual.id_Estudiante + '">    Eliminar</a></td></tr > ';
